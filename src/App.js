  ...
  return (
    <div className="App">
      <div id="about">
        ...
        <div id="small">
        <p><small>i share a birthday with my melody (jan. 18th), im a capricorn, and i love coffee and tangerine juice.
        ...
        <p><small>as of right now, i hardly have any free time though while i finish up my studies and learn about operating systems
